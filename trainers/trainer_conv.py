    ...
    def _train(self, sess):
        ...
        for i_epoch in range(self.params['max_epoches']):
            ...
            for img_frame_vecs, img_frame_n, ques_vecs, ques_n, ques_word, ans_vecs, ans_n, ans_word, type_vec, batch_size in self.train_batcher.generate():
                ...
                # print('ans_vecs*****************************', batch_data[self.model.ans_vecs].shape, batch_data[self.model.ans_vecs].dtype)
                # print('ques_vecs*****************************', batch_data[self.model.ques_vecs].shape, batch_data[self.model.ques_vecs].dtype)
                ...
                if i_batch % self.params['display_batch_interval'] == 0:
                    ...
                    i_epoch, i_batch, train_loss, (t2 - t1) / self.params['display_batch_interval']))
